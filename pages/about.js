...
const Contact = props => (
  <Layout>
    ...
    <br/><br/><br/><br/>
      <Row>
      <div className="mb-8">
      <p>Отдел кастинга Школы-студии «DЕТИКИНО» занимается поиском возможностей для реализации учениками Школы полученных в ней знаний и навыков на профессиональных съёмочных площадках в России и за рубежом, представляет интересы воспитанников Школы перед киностудиями, согласовывает договор и оформляет документы актёра в случае утверждения на роль, «ведёт» их на протяжении съёмочного процесса и действия договора.</p>
      </div>
      </Row>
    </div>  
    </Container>
