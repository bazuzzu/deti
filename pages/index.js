...
// endmail  
  ...
  return (
    <Layout>
      <Head>
        <title>Актёрское агентство Школы-студии DЕТИКИНО</title>
      </Head>
      <Container
        id="boys"
      ...
      >
        ...
        <h2 className="text-3xl font-fancy pt-3 pr-12">Актёрское агентство<br/> Школы-студии<br/> DЕТИКИНО</h2>
		...
		<div className="generating">Кастинг-лист генерируется<br/>Пожалуйста, подождите.</div>
      </Container>
    </Layout>
  )
}
