      ...
      >
        ...
        <div className="flex flex-col md:flex-row sunday-wrapper">
          <a href="#girls">
            <h1
              className={classnames(
                "font-sans text-orange mt-4 md:mt-8 lg:mb-8 text-4xl sm:text-6xl lg:text-7xl xl:text-7xl font-heavy tracking-tighter leading-tight md:pr-8 transition-colors duration-150 cursor-pointer text-black hover:text-gray-600"
              )}
            >
              ДЕВОЧКИ.
            </h1>
          ...
          <a href="#boys">
            <h1
              className={classnames(
                "font-sans text-orange md:mt-8 mb-8 md:mb-12 text-4xl sm:text-6xl lg:text-7xl xl:text-7xl font-heavy tracking-tighter leading-tight text-gray-400 hover:text-gray-600 transition-colors duration-150 cursor-pointer text-gray-400 hover:text-gray-600"
              )}
            >
              МАЛЬЧИКИ.
            </h1>
